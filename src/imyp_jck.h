...
extern void imyp_jack_pause IMYP_PARAMS ((
	const imyp_backend_data_t * const imyp_data,
	const int milliseconds));
extern void imyp_jack_put_text IMYP_PARAMS ((
	const imyp_backend_data_t * const imyp_data,
	const char * const text));
extern int imyp_jack_play_tune IMYP_PARAMS ((
	imyp_backend_data_t * const imyp_data,
	const double freq, const int volume_level,
	const int duration, void * const buf, int bufsize));
extern int imyp_jack_init IMYP_PARAMS ((
	imyp_backend_data_t ** const imyp_data,
	const char * const dev_file));
extern int imyp_jack_close IMYP_PARAMS ((
	imyp_backend_data_t * const imyp_data));
extern void imyp_jack_version IMYP_PARAMS ((
	const imyp_backend_data_t * const imyp_data));

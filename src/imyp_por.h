...
extern void imyp_portaudio_pause IMYP_PARAMS ((
	const imyp_backend_data_t * const imyp_data,
	const int milliseconds));
extern void imyp_portaudio_put_text IMYP_PARAMS ((
	const imyp_backend_data_t * const imyp_data,
	const char * const text));
extern int imyp_portaudio_play_tune IMYP_PARAMS ((
...
extern int imyp_portaudio_init IMYP_PARAMS ((
	imyp_backend_data_t ** const imyp_data,
	const char * const dev_file));
extern int imyp_portaudio_close IMYP_PARAMS ((
	imyp_backend_data_t * const imyp_data));
extern void imyp_portaudio_version IMYP_PARAMS ((
	const imyp_backend_data_t * const imyp_data));

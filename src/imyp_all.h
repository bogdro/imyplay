...
extern void imyp_all_pause IMYP_PARAMS ((
	const imyp_backend_data_t * const imyp_data,
	const int milliseconds));
extern void imyp_all_put_text IMYP_PARAMS ((
	const imyp_backend_data_t * const imyp_data,
	const char * const text));
extern int imyp_all_play_tune IMYP_PARAMS ((
	imyp_backend_data_t * const imyp_data,
	const double freq, const int volume_level,
	const int duration, void * const buf, int bufsize));
extern int imyp_all_init IMYP_PARAMS ((
	imyp_backend_data_t ** const imyp_data,
	const char * const dev_file));
extern int imyp_all_close IMYP_PARAMS ((
	imyp_backend_data_t * const imyp_data));
extern void imyp_all_version IMYP_PARAMS ((
	const imyp_backend_data_t * const imyp_data));

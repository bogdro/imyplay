...
extern void imyp_alsa_pause IMYP_PARAMS ((
	const imyp_backend_data_t * const imyp_data,
	const int milliseconds));
extern void imyp_alsa_put_text IMYP_PARAMS ((
	const imyp_backend_data_t * const imyp_data,
	const char * const text));
extern int imyp_alsa_play_tune IMYP_PARAMS ((
	imyp_backend_data_t * const imyp_data,
	const double freq, const int volume_level,
	const int duration, void * const buf, int bufsize));
extern int imyp_alsa_init IMYP_PARAMS ((
	imyp_backend_data_t ** const imyp_data,
	const char * const dev_file));
extern int imyp_alsa_close IMYP_PARAMS ((
	imyp_backend_data_t * const imyp_data));
extern void imyp_alsa_version IMYP_PARAMS ((
	const imyp_backend_data_t * const imyp_data));
